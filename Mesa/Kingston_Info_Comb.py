...
def write_to_RDDL(agent_complete, params_used, horizon_used):
    ...
    with open('problem.rddl', 'w') as f:
        ...
        f.write('\t\tMASK_FACTOR = ' + str(params_used[4]) + ';')
        f.write('\n')
        f.write('\t\tVACCINE_FACTOR = ' + str(params_used[2]) + ';')
        f.write('\n')
        f.write('\t\tMASK_CHANCE = ' + str(params_used[3]) + ';')
        f.write('\n')
        f.write('\t\tBASIC_REPR_RATIO = ' + str(params_used[1]) + ';')
        f.write('\n')
        f.write('\t\tISOLATION_RATE = ' + str(params_used[0]) + ';')
        f.write('\n')
        f.write('\n')
        ...
        f.write('\n')
        f.write('\n')
        f.write('\thorizon = ' + str(horizon_used) + ';')
        f.write('\n')
...
def main_kingston_geo(sim_mode, rddl_params, rddl_horizon):
    ...
    if (sim_mode == "NetLogo"):
        ...
        write_to_RDDL(agent_complete, rddl_params, rddl_horizon)
